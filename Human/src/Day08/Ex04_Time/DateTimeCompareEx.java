...
public class DateTimeCompareEx {
	...
	public static void main(String[] args) {
		...
		if(todayDateTime.isEqual(endDateTime)) {
		...
		//until
		//LocalDateTime 개게의 날짜/시간부터 인자로 지정한 객체의 날짜 시간까지 
		//남은 시간을 반환하는 메소드
